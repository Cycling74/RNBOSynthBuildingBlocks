...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 25.5, 117.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 25.5, 184.0, 100.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 25.5, 149.0, 50.0, 22.0 ],
					"text" : "midiinfo"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 85.5, 220.0, 40.0, 22.0 ],
					"text" : "midiin"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 58.0, 390.0, 174.0, 41.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 58.0, 461.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 136.0, 184.0, 60.0, 22.0 ],
					"text" : "pack 0 0"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 136.0, 149.0, 109.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 136.0, 75.0, 225.0, 64.0 ],
					"range" : 25
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "" ],
					"patching_rect" : [ 136.0, 220.0, 82.0, 22.0 ],
					"text" : "midiformat"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 58.0, 289.0, 35.0, 22.0 ],
					"text" : "open"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"patching_rect" : [ 80.0, 222.0, 42.0, 23.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 80.0, 158.0, 30.0, 23.0 ],
									"rnbo_extra_attributes" : 									{
										"unit" : "ms"
									}
,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 80.0, 123.0, 33.0, 23.0 ],
									"rnbo_extra_attributes" : 									{
										"hires" : 1.0
									}
,
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 80.0, 307.0, 43.0, 23.0 ],
									"rnbo_extra_attributes" : 									{
										"comment" : ""
									}
,
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 384.5, 335.0, 126.0, 23.0 ],
													"rnbo_serial" : 1,
													"rnbo_uniqueid" : "eventoutlet_obj-31",
													"rnboinfo" : 													{
														"needsInstanceInfo" : 0,
														"argnames" : 														{
															"index" : 															{
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 154.5, 335.0, 157.0, 23.0 ],
													"rnbo_serial" : 1,
													"rnbo_uniqueid" : "signaloutlet_obj-25",
													"rnboinfo" : 													{
														"needsInstanceInfo" : 0,
														"argnames" : 														{
															"in1" : 															{
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "" ],
													"patching_rect" : [ 384.5, 213.0, 281.0, 23.0 ],
													"rnbo_extra_attributes" : 													{
														"enum" : "",
														"order" : "",
														"exponent" : 1.0,
...
,
													"text" : "param release 500 @minimum 0 @maximum 10000",
													"varname" : "release"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "" ],
													"patching_rect" : [ 327.0, 182.0, 101.0, 23.0 ],
													"rnbo_extra_attributes" : 													{
														"maximum" : 1.0,
														"enum" : "",
														"order" : "",
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "" ],
													"patching_rect" : [ 269.5, 154.0, 280.0, 23.0 ],
													"rnbo_extra_attributes" : 													{
														"enum" : "",
														"order" : "",
														"exponent" : 1.0,
...
,
													"text" : "param decay 100 @minimum 0 @maximum 100000",
													"varname" : "decay"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "signal" ],
													"patching_rect" : [ 154.5, 91.0, 126.0, 23.0 ],
													"rnbo_serial" : 1,
													"rnbo_uniqueid" : "signalinlet_obj-13",
													"rnboinfo" : 													{
														"needsInstanceInfo" : 0,
														"argnames" : 														{
															"out1" : 															{
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 22.0, 333.0, 108.0, 37.0 ],
													"rnbo_serial" : 2,
													"rnbo_uniqueid" : "signaloutlet_obj-9",
													"rnboinfo" : 													{
														"needsInstanceInfo" : 0,
														"argnames" : 														{
															"in1" : 															{
...
,
													"text" : "out~ 1 @comment \"Modified signal\""
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "signal" ],
													"patching_rect" : [ 22.0, 52.0, 132.0, 23.0 ],
													"rnbo_serial" : 2,
													"rnbo_uniqueid" : "signalinlet_obj-8",
													"rnboinfo" : 													{
														"needsInstanceInfo" : 0,
														"argnames" : 														{
															"out1" : 															{
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "signal" ],
													"patching_rect" : [ 22.0, 291.0, 29.5, 23.0 ],
													"rnbo_serial" : 1,
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "signal", "" ],
													"patching_rect" : [ 154.5, 249.0, 249.0, 23.0 ],
													"rnbo_serial" : 1,
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "" ],
													"patching_rect" : [ 212.0, 126.0, 275.0, 23.0 ],
													"rnbo_extra_attributes" : 													{
														"enum" : "",
														"order" : "",
														"exponent" : 1.0,
...
,
													"text" : "param attack 10 @minimum 0 @maximum 100000",
													"varname" : "attack"
												}
...
,
									"patching_rect" : [ 80.0, 261.0, 114.0, 23.0 ],
									"rnbo_extra_attributes" : 									{
										"args" : "",
										"receivemode" : "local",
										"file" : "",
...
,
											"notecontroller" : 											{
												"attrOrProp" : 2,
												"digest" : "Note controller to use: internal (default) / external",
												"isalias" : 0,
												"aliases" : [  ],
												"settable" : 1,
												"attachable" : 0,
...
,
											"receivemode" : 											{
												"attrOrProp" : 2,
												"digest" : "Do receive~ objects get the signal from a send~ inside the patcher directly (without latency), or compensated (with latency, aligend with all other voices).",
												"isalias" : 0,
												"aliases" : [  ],
												"settable" : 1,
												"attachable" : 0,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 175.0, 158.0, 30.0, 23.0 ],
									"rnbo_extra_attributes" : 									{
										"unit" : "ms"
									}
,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 175.0, 123.0, 29.5, 23.0 ],
									"rnbo_serial" : 2,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "", "", "", "" ],
									"patching_rect" : [ 80.0, 71.0, 50.5, 23.0 ],
									"rnbo_serial" : 1,
...
,
					"patching_rect" : [ 58.0, 343.0, 97.0, 22.0 ],
					"rnboattrcache" : 					{
						"env.adsr/attack" : 						{
							"label" : "attack",
							"isEnum" : 0,
...
,
									"fileref" : 									{
										...
										"filepos" : -1,
										"snapshotfileid" : "3baecd86fe5caee261d962a271562087"
									}
