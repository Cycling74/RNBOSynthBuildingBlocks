...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 26.0, 20.0, 71.0, 22.0 ],
					"text" : "sbb.mod.lfo"
				}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 208.0, 218.0, 50.0, 23.0 ],
									"rnbo_extra_attributes" : 									{
										"value" : 64.0,
										"preset" : 0
									}
